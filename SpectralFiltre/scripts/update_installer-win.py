...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SpectralFiltre Demo Installer\n"
      else:
        line="OutputBaseFilename=SpectralFiltre Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SpectralFiltre Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SpectralFiltre installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SpectralFiltre Demo installer\n"
     else:
       line="SetupWindowTitle=SpectralFiltre installer\n"
