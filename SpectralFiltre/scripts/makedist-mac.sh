...
NOTARIZE_BUNDLE_ID=com.BEnjaminChaval.SpectralFiltre
NOTARIZE_BUNDLE_ID_DEMO=com.BEnjaminChaval.SpectralFiltre.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/SpectralFiltre.iss
#  git checkout installer/SpectralFiltre.pkgproj
