...
#define AUV2_ENTRY SpectralFiltre_Entry
#define AUV2_ENTRY_STR "SpectralFiltre_Entry"
#define AUV2_FACTORY SpectralFiltre_Factory
#define AUV2_VIEW_CLASS SpectralFiltre_View
#define AUV2_VIEW_CLASS_STR "SpectralFiltre_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "SpectralFiltre\nIPEF"
